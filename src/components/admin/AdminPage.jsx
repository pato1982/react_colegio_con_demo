...
function AdminPage({ usuario, onCerrarSesion }) {
    ...
    const tabs = [
        ...
        { id: 'notas-por-curso', label: 'Sábana de Notas', desc: `En esta sección podrá visualizar las notas de cada curso del establecimiento, organizadas por asignatura y con opción de filtrar por ${usuario?.modalidad_academica === 'semestral' ? 'semestre' : 'trimestre'}.`, icon: 'menu_book', color: 'morado' },
